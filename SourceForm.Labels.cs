    ...
    internal partial class SourceForm
    {
        internal void print_capture_label(CaptureLabel cl)
        {
            ControlRoutines.Invoke(this, () =>
            {
                ...
                TextBox.SelectionBackColor = Settings1.Appearance.GetFilterBackColor(cl.level);
                TextBox.SelectionColor = cl.fgcolor;
                TextBox.SelectionFont = Settings1.Appearance.CaptureLabelFont;
            });
        }
        ...
        {
            if (Settings1.Appearance.StripParsedTextInStatusBarFromHtmlTags)
            {
