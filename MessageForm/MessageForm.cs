...
namespace Cliver
{
    ...
    public partial class MessageForm : System.Windows.Forms.Form
    {
        ...
        /// <summary>
        /// Sound file to be played as the message window is showed.
        /// </summary>
        public string SoundFile = null;

        /// <summary>
        /// Whether sound will be repeated endlessly until the window is closed.
        /// </summary>
        ...
        void construct_form(string caption, string message, Color[] button_colors, string[] answers, int default_answer, string silent_box_text, Image image)
        {
            ...
            {//calculate label size
                ...
                this.label.Height = (int)l_size.Height + 16;
